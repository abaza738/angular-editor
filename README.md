...
This repository is a fork of a fork, intention is to take a single change made by Yashiru that wasn't merged onto the main repo.  
Thanks to @kolkov and @Yashiru for their contributions.
